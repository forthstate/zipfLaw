...
from zipfLaw import utilities as util
...
def main():
    ...
    for fname in args.infiles:
        try:
            ...
            msg = f'{fname} is not Processed: File does not exist'
            logging.warning(msg)
        except PermissionError:
            msg = f'{fname} is not Processed: No read permission'
            logging.warning(msg)
        except Exception as error:
            msg = f'{fname} is not Processed: {error}'
            logging.warning(msg)
